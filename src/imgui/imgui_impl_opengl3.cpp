...
// GL includes
#include <gfx/glad.h> // Needs to be initialized with gladLoadGL() in user's code.
...
static char         g_GlslVersionString[32] = "#version 450";   // Specified by user or detected based on compile time GL settings.
